...
export default function PersonalizedRecommendations() {
  return (
    <section className="section bg-white" id="personalized">
      <div className="section-inner split-section">
        ...
        <div className="mockup-container">
          ...
          <div className="mockup-floating-img shadow-md">
        ...
        {/* Right: Text Content */}
        <div className="text-content pr-lg">
          <h2 className="section-title text-left" style={{ fontSize: 'clamp(36px, 4.5vw, 52px)', lineHeight: 1.15, letterSpacing: '-1.5px' }}>Get personalized<br />recommendations.</h2>
